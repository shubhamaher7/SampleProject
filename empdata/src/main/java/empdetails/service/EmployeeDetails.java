...
import empdetails.dao.EmployeeDetailsDao;
...
import empdetails.util.EmployeeValidation;
...
public class EmployeeDetails implements IEmployeeDetails{
	...
	public List<Employee> viewEmpById(int empId) throws EmployeeNotFoundException, ClassNotFoundException, SQLException {
		// TODO Auto-generated method stub
		empDao = new EmployeeDetailsDao();
		List<Employee> empList = new ArrayList<Employee>();
		//empDao.viewEmp();
		empList = empDao.viewEmpById(empId);
		if(empList.isEmpty())
		{
			throw new EmployeeNotFoundException("No Employee Details");
		}
